...
function Projects() {
  const projects = [
    ...
    },
    {
      ...
      image: "/punjab-fc.png",
      link: "https://play.google.com/store/apps/details?id=com.zaanvar.mrchams",
    },
  ];
          ...
          <div className="projects-row">
            ...
            <div className="project-col project-col-6">
              <a
                ...
                aria-label={`Visit ${projects[0].title}`}
              >
            ...
            <div className="project-col project-col-6">
              <a
                ...
                rel="noopener noreferrer"
                className="project-card-link"
                aria-label={`Visit ${projects[1].title}`}
              >
                <div className="project-card">
                  <div className="project-content">
                    <span className="project-category">
          ...
          <div className="projects-row">
            ...
            <div className="project-col project-col-4">
              <a
                ...
                rel="noopener noreferrer"
                className="project-card-link"
                aria-label={`Visit ${projects[2].title}`}
              >
                <div className="project-card">
                  <div className="project-content">
                    <span className="project-category">
            ...
            <div className="project-col project-col-4">
              <a
                ...
                rel="noopener noreferrer"
                className="project-card-link"
                aria-label={`Get ${projects[3].title} on Google Play`}
              >
                <div className="project-card">
                  <div className="project-content">
                    <span className="project-category">
